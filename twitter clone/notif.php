...
<a href="tweets.php" style="z-index:105;color:black;"><i class="fa fa-envelope-o" aria-hidden="true" style="width:40px;z-index:105;position:fixed;top:38px;right:130px;font-size:40px;"></i></a>
    ...
    <?php
      ...
      $query="select * from notifications where uname='$fname' and name!='$fname' order by nid desc";
      ...
      $id=$row6["uid"];
          ...
          echo "<h4 style='margin:-200px 0px 0px 250px;color:red;'>$t</h4>";
            ...
            echo "<h3 style='margin:50px 0px 0px 70px;'>$about</h3>";
            echo "<h4 style='margin:-97px 0px 0px 250px;color:red;'>$t</h4>";
          ...
          echo "<a href='like.php?id=$name&about=$about' name='like'><i class='fa fa-heart' aria-hidden='true' style='margin:200px 0px 0px 185px;color:grey;font-size:20px;'></i></a>";
          ...
          echo "<a href='viewlikes.php?lname=$name&topic=$about' style='text-decoration:none;'><h4 style='margin:-70px 0px 50px 270px;color:black;'>view all $nil likes</h4></a>";
            ...
            echo "<a href='unlike.php?id=$name&about=$about' name='unlike'><i class='fa fa-heart' aria-hidden='true' style='margin:180px 0px 0px 185px;color:red;black;font-size:20px;'></i></a>";
...
<?php
 $fname=$_SESSION["name"];
 $conn=mysqli_connect("localhost","root","","tweet")or die("connection failed");
 $query="update notifications set status='1'where uname='$fname' and status='0'";
 $run=mysqli_query($conn,$query);
