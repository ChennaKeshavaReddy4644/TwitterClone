...
while($row=mysqli_fetch_assoc($run)){
    ...
    $query1="select * from comments where uname='$fname' and cname='$name' and topic='$about'";
      ...
      $id=$row6["uid"];
          echo "<div style='margin:110px 0px -109px 50px;width:400px;height:290px;background:white;opacity:1;border:1px solid black;border-radius:10px;'>";
          ...
          echo "<h4 style='margin:-200px 0px 0px 250px;color:red;'>$time</h4>";
            ...
            echo "<h4 style='margin:-55px 0px 0px 250px;color:red;'>$time</h4>";
          }
          if($nc==0 && $nl==0){
